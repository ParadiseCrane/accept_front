export const validation = {
  ...
  description: 'Задача должна иметь описание хотя бы из 20 символов',
  ...
  complexity: {
    least: 'Сложность должен быть не меньше 1%',
  ...
  testField: {
    empty: 'Поле теста не может быть пустым',
    tooLong: 'Длина поля теста слишком велика',
  },
  hintContent:
